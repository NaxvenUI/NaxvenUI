...
**Pure HTML, CSS & JS. No frameworks. Just clean UI.**
...
|---|---|---|---|
| Hotel Management Dashboard | Dashboard | 99 | 93 |
| Netflix Clone | Landing Page | coming soon | coming soon |
| Sport Store | Landing Page | coming soon | coming soon |
| Gym & Fitness | Landing Page | coming soon | coming soon |
| Travel Agency | Landing Page | coming soon | coming soon |
| Restaurant | Landing Page | coming soon | coming soon |
| Perfume Store | Landing Page | coming soon | coming soon |
| Luxury Watch Store | Landing Page | coming soon | coming soon |
...
1. Watch the full build on [YouTube](https://www.youtube.com/@NaxvenUI)
2. Download the starting materials free from each repo
3. Follow along and write the code yourself
4. Or grab the finished premium template on [Buy Me a Coffee](https://buymeacoffee.com/naxvenui)
